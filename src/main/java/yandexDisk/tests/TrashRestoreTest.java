...
public class TrashRestoreTest extends BaseTest {
    ...
    public void deleteOneFile() {
        ...
        boolean doesMessageMatchExpected = fileService.isNotificationMessageExpected(FILE_WAS_DELETED_NOTIFICATION_MESSAGE, fileName);
    ...
    public void checkFileRemovedFromMainFolder() {
        boolean isFileVisible = fileService.isFileVisibleInFolder(oneFileSelectedList);
    ...
    public void checkDeletedFileInTrash() {
        boolean isFileVisible = fileService.isFileVisibleInTrashFolder(oneFileSelectedList);
    ...
    public void restoreFile() {
        ...
        boolean doesMessageMatchExpected = fileService.isNotificationMessageExpected(FILE_WAS_RESTORED_NOTIFICATION_MESSAGE, fileName);
        Assert.assertTrue(doesMessageMatchExpected, "Notification message doesn't match");
    }
    ...
    public void checkRestoredFileInMainFolder() {
        boolean isFileVisible = fileService.isFileVisibleInMainFolder(oneFileSelectedList);
    ...
    public void deleteSeveralFilesAtOnce() {
        ...
        boolean isNotificationVisible = fileService.isNotificationVisible();
    ...
    public void checkDeletedFilesInMainFolder() {
        boolean areFilesVisible = fileService.isFileVisibleInFolder(expectedFileList);
    ...
    public void checkDeletedFilesInTrash() {
        boolean areFilesVisible = fileService.isFileVisibleInTrashFolder(expectedFileList);
    ...
    public void deleteFilePermanentlyFromTrash() {
        ...
        boolean doesNotificationMessageMatchExpected = fileService.isNotificationMessageExpected(FILE_WAS_PERMANENTLY_DELETED_NOTIFICATION_MESSAGE, fileName);
