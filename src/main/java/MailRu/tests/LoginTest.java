...
public class LoginTest extends BaseTest {
    ...
    public void loginWithValidCredentials() {
        boolean doesUserLoginMatch = authorizationService.checkUserLoginAfterAuthorization(VALID_USER_ACCOUNT);
    ...
    public void loginWithInvalidLogin(String login, String password, String expectedErrorMessage) {
        ...
        boolean doesErrorMessageMatch = authorizationService.checkErrorMessageWhileLoginWithInvalidCredentials(user, expectedErrorMessage);
